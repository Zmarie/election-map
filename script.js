...
// tallied results
console.log(patrick.results);
console.log(david.results); 
patrick.talliedUpVotes(); console.log(patrick.totalVotes);
david.talliedUpVotes(); console.log(david.totalVotes);
